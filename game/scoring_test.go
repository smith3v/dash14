...
func TestScoringFinishable(t *testing.T) {
	tests := []struct {
		...
		{name: "0-0 not finishable", set: SetScore{0, 0, 1}, wantFinish: false},
		{name: "24-22 not finishable", set: SetScore{24, 22, 1}, wantFinish: false},
		{name: "24-24 deuce not finishable", set: SetScore{24, 24, 1}, wantFinish: false},

		// Exactly 25 for home with sufficient lead
		{name: "25-0 finishable", set: SetScore{25, 0, 1}, wantFinish: true},
		{name: "25-22 finishable", set: SetScore{25, 22, 1}, wantFinish: true},
		{name: "25-23 finishable", set: SetScore{25, 23, 2}, wantFinish: true},

		// Deuce scenarios at 25
		{name: "25-24 not finishable", set: SetScore{25, 24, 1}, wantFinish: false},
		{name: "25-25 not finishable", set: SetScore{25, 25, 3}, wantFinish: false},

		// Extended deuce resolved
		{name: "26-24 finishable", set: SetScore{26, 24, 1}, wantFinish: true},
		{name: "27-25 finishable", set: SetScore{27, 25, 4}, wantFinish: true},
		{name: "26-25 not finishable", set: SetScore{26, 25, 2}, wantFinish: false},

		// Exactly 25 for guest with sufficient lead
		{name: "0-25 finishable", set: SetScore{0, 25, 2}, wantFinish: true},
		{name: "23-25 finishable", set: SetScore{23, 25, 3}, wantFinish: true},
		{name: "24-25 not finishable", set: SetScore{24, 25, 4}, wantFinish: false},
		{name: "24-26 finishable (guest)", set: SetScore{24, 26, 1}, wantFinish: true},

		// Set 5 uses 15-point threshold (basic coverage; Task 12 will expand)
		{name: "set5 14-12 not finishable", set: SetScore{14, 12, 5}, wantFinish: false},
		{name: "set5 15-13 finishable", set: SetScore{15, 13, 5}, wantFinish: true},
		{name: "set5 15-14 not finishable", set: SetScore{15, 14, 5}, wantFinish: false},
		{name: "set5 16-14 finishable", set: SetScore{16, 14, 5}, wantFinish: true},
	}
